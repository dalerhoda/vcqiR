...
# RI_COVG_03_06PO R version 1.01 - Biostat Global Consulting - 2023-07-23
# *******************************************************************************
# Change log
...
RI_COVG_03_06PO <- function(VCP = "RI_COVG_03_06PO"){
  ...
  if (VCQI_MAKE_OP_PLOTS == 1){
    ...
    if (VCQI_NO_DOBS != 1){
      vlist <- c("fully_vaccinated_crude", "fully_vaccinated_valid", "fully_vaccinated_by_age1")
    }
    ...
    for (v in seq_along(vlist)){
      ...
      for (i in 1:opp_nstrata){
        ...
        filestub <- paste0("RI_COVG_03_",ANALYSIS_COUNTER,"_opplot_",abbrev,"_",id,"_",name)
  ...
  if (VCQI_MAKE_IW_PLOTS == 1){
    ...
    vcqi_to_plot(database = paste0(VCQI_OUTPUT_FOLDER, "/RI_COVG_03_",ANALYSIS_COUNTER,"_fvc_database.rds"),
                 filename = savepng,
                 datafile = paste0(VCQI_OUTPUT_FOLDER, "/RI_COVG_03_",ANALYSIS_COUNTER,".rds"),
                 title = "RI - Fully Vaccinated - Crude",
    ...
    if (VCQI_NO_DOBS != 1){
      ...
      vcqi_to_plot(database = paste0(VCQI_OUTPUT_FOLDER, "/RI_COVG_03_",ANALYSIS_COUNTER,"_fvv_database.rds"),
                   filename = savepng,
                   datafile = paste0(VCQI_OUTPUT_FOLDER, "/RI_COVG_03_",ANALYSIS_COUNTER,".rds"),
      ...
      vcqi_to_double_plot(database = paste0(VCQI_OUTPUT_FOLDER, "/RI_COVG_03_",ANALYSIS_COUNTER,"_fvv_database.rds"),
                          database2 = paste0(VCQI_OUTPUT_FOLDER, "/RI_COVG_03_",ANALYSIS_COUNTER,"_fvc_database.rds"),
                          filename = savepng,
                          datafile = paste0(VCQI_OUTPUT_FOLDER, "/RI_COVG_03_",ANALYSIS_COUNTER,".rds"),
                          datafile2 = paste0(VCQI_OUTPUT_FOLDER, "/RI_COVG_03_",ANALYSIS_COUNTER,".rds"),
                          title = "RI - Fully Vaccinated - Valid",
      ...
      vcqi_to_plot(database = paste0(VCQI_OUTPUT_FOLDER, "/RI_COVG_03_",ANALYSIS_COUNTER,"_fva1_database.rds"),
                   filename = savepng,
                   datafile = paste0(VCQI_OUTPUT_FOLDER, "/RI_COVG_03_",ANALYSIS_COUNTER,".rds"),
                   title = "RI - Fully Vaccinated - Valid by Age 1",
