...
# VCTC_default_global R version 1.04 - Biostat Global Consulting - 2024-05-15
# *******************************************************************************
# Change log
...
# 2024-05-15  1.04      Mia Yu          Added multi lingual strings
# *******************************************************************************
...
VCTC_default_global <- function(){
  ...
  #"Not vaccinated means the child did not receive any of the doses from the fully vaccinated dose list."
