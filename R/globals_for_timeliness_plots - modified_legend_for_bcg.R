...
# VCTC_global_modified_legend_for_bcg R version 1.00 - Biostat Global Consulting - 2023-07-18
# *******************************************************************************
# Change log
...
VCTC_global_modified_legend_for_bcg <- function(){
  ...
  assign("TIMELY_LEGEND_ORDER",
         c("DT_1","CD_BCG_1","DT_2","DT_3","DT_4","DT_5","CD_BCG_4"),
         envir = .GlobalEnv)
