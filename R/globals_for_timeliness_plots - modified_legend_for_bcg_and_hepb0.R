...
# VCTC_global_modified_legend_for_bcg_hepb0 R version 1.00 - Biostat Global Consulting - 2024-05-15
# *******************************************************************************
# Change log
...
VCTC_global_modified_legend_for_bcg_hepb0 <- function(){
  ...
  assign("TIMELY_CD_HEPB0_COLOR_4", "#e0e0e0", envir = .GlobalEnv)
  ...
  assign("TIMELY_CD_HEPB0_LABEL_1", language_string(language_use = language_use, str = "OS_508"), envir = .GlobalEnv)
  assign("TIMELY_CD_HEPB0_LABEL_2", language_string(language_use = language_use, str = "OS_446"), envir = .GlobalEnv)
  assign("TIMELY_CD_HEPB0_LABEL_3", language_string(language_use = language_use, str = "OS_447"), envir = .GlobalEnv)
  assign("TIMELY_CD_HEPB0_LABEL_4", language_string(language_use = language_use, str = "OS_448"), envir = .GlobalEnv)

  assign("TIMELY_CD_HEPB0_LEGEND_LABEL_1", language_string(language_use = language_use, str = "OS_509"), envir = .GlobalEnv)
  assign("TIMELY_CD_HEPB0_LEGEND_LABEL_2", language_string(language_use = language_use, str = "OS_446"), envir = .GlobalEnv)
  assign("TIMELY_CD_HEPB0_LEGEND_LABEL_3", language_string(language_use = language_use, str = "OS_447"), envir = .GlobalEnv)
  assign("TIMELY_CD_HEPB0_LEGEND_LABEL_4", language_string(language_use = language_use, str = "OS_448"), envir = .GlobalEnv)
  ...
  # assign("TIMELY_CD_HEPB0_LEGEND_LABEL_2", "< 2 Months Late", envir = .GlobalEnv)
