#' Pre-process dataset for RI_CONT_01B
#'
...
# RI_CONT_01B_01PP R version 1.01 - Biostat Global Consulting - 2024-03-20
# *******************************************************************************
# Change log

# Date 			  Version 	Name			      What Changed
# 2023-07-18  1.00      Mia Yu          Original R package version; add level3name
# 2024-03-20  1.01      Mia Yu          Add VCQI_PASS_THRU_VARLIST to selection list
# *******************************************************************************


RI_CONT_01B_01PP <- function(VCP = "RI_CONT_01B_01PP"){
  ...
  if (!vcqi_object_exists("RI_CONT_01B_TEMP_DATASETS")){
    RI_CONT_01B_TEMP_DATASETS <- NULL
  }
  vcqi_global(RI_CONT_01B_TEMP_DATASETS,
              c(RI_CONT_01B_TEMP_DATASETS,
                paste0("RI_CONT_01B_", ANALYSIS_COUNTER, ".rds")
              ))
